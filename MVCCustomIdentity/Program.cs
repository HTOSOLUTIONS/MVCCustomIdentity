...
using MVCCustomIdentitySample.Authentication;
using MVCCustomIdentitySample.Data;
...
///Remove the DefaultIdentity configuration and add the custom UserClaimsPrincipalFactory
